...
def sprint5_example_stg_bonus_system_ranks_users_events_dag():
    ...
    # Объявляем таск, который загружает данные ranks
    ...
    # Объявляем таск, который загружает данные users
    ...
    # Объявляем таск, который загружает данные events
...
stg_bonus_system_ranks_users_events_dag = sprint5_example_stg_bonus_system_ranks_users_events_dag()
