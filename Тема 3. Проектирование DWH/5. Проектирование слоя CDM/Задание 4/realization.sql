ALTER TABLE cdm.dm_settlement_report ADD CONSTRAINT orders_count_positive
CHECK (orders_count >= 0);
ALTER TABLE cdm.dm_settlement_report ADD CONSTRAINT orders_total_sum_positive
CHECK (orders_total_sum >= 0);
ALTER TABLE cdm.dm_settlement_report ADD CONSTRAINT orders_bonus_payment_sum_positive
CHECK (orders_bonus_payment_sum >= 0);
ALTER TABLE cdm.dm_settlement_report ADD CONSTRAINT orders_bonus_granted_sum_positive
CHECK (orders_bonus_granted_sum >= 0);
ALTER TABLE cdm.dm_settlement_report ADD CONSTRAINT order_processing_fee_positive
CHECK (order_processing_fee >= 0);
ALTER TABLE cdm.dm_settlement_report ADD CONSTRAINT restaurant_reward_sum_positive
